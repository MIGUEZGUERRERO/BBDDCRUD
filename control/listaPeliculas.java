...
public class listaPeliculas {
	...
	/**
	 * Devuelve una cadena de caracteres del objeto hollywood.
	 * 
	 * @return Una cadena de caracteres del objeto hollywood.
	 */
	@Override
	public String toString() {
		return "listaPeliculas [hollywood=" + hollywood + "]";
	}
	...
	public void modificarPelicula() {
		...
		do {
			...
			if (peliculaEncontrada == null) {
				...
				System.out.println("Título actual de la película: " + peliculaEncontrada.getTitulo());
				...
				peliculaModificada.setEstreno(entrada.nextInt());
				entrada.nextLine();

				peliculas miPeliculas = peliculaModificada;
				String sql = transformarsql.update(miPeliculas, peliculaEncontrada.getTitulo());
				BaseDatos.accionSQL(sql);
	...
	public void buscarPelicula() {
		...
		if (peliculaEncontrada != null) {
			...
			BaseDatos.buscarPeliculasSQL(tituloPelicula);
	...
	public void mostrarPeliculas() {
		...
		for (peliculas pelicula : hollywood) {
			...
			String sql = transformarsql.mostrar(miPeliculas);
	...
	/**
	 * Método que busca una película en una lista a partir de su título.
	 * 
	 * @param lista  /Lista de películas en la que buscar.
	 * @param titulo /Titulo de la película a buscar.
	 * @return La película encontrada o null si no se encontró.
	 */
	public peliculas buscadorpeliculas(ArrayList<peliculas> hollywood, String tituloPelicula) {
		int i = 0;
